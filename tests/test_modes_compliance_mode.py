...
@patch("gitlab_compliance_checker.ui.compliance.get_project_branches")
@patch("gitlab_compliance_checker.ui.compliance.st")
@patch("gitlab_compliance_checker.ui.compliance.cached_get_project")
@patch("gitlab_compliance_checker.ui.compliance.run_project_compliance_checks")
def test_render_batch_project_compliance_internal(
    mock_run, mock_get, mock_st, mock_branches, mock_gl_client, mock_project
):
    mock_st.text_area.return_value = "gp/p1\ngp/p2"
    mock_st.text_input.return_value = "main"
